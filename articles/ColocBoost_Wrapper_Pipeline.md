...
**Expected format for LD metadata file** LD files sould be in the format
generated by for instance `plink --r squared`, then xz compressed. The
LD metadata file is a tab-separated file with the following columns: -
